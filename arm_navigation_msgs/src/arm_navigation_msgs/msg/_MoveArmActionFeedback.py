"""autogenerated by genpy from arm_navigation_msgs/MoveArmActionFeedback.msg. Do not edit."""
import sys
...
class MoveArmActionFeedback(genpy.Message):
  _md5sum = "50284463bfe759fbf589fc263537baad"
  _type = "arm_navigation_msgs/MoveArmActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm_navigation_msgs/MoveArmFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = arm_navigation_msgs.msg.MoveArmFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = arm_navigation_msgs.msg.MoveArmFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i.pack(_x.feedback.time_to_completion.secs, _x.feedback.time_to_completion.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.time_to_completion.secs, _x.feedback.time_to_completion.nsecs,) = _struct_2i.unpack(str[start:end])
      return self
