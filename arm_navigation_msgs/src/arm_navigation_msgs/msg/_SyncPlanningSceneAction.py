"""autogenerated by genpy from arm_navigation_msgs/SyncPlanningSceneAction.msg. Do not edit."""
import sys
...
class SyncPlanningSceneAction(genpy.Message):
  _md5sum = "98a7de8683022cf0184b72a226932f22"
  _type = "arm_navigation_msgs/SyncPlanningSceneAction"
...
"""
  ...
  _slot_types = ['arm_navigation_msgs/SyncPlanningSceneActionGoal','arm_navigation_msgs/SyncPlanningSceneActionResult','arm_navigation_msgs/SyncPlanningSceneActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SyncPlanningSceneAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = arm_navigation_msgs.msg.SyncPlanningSceneActionGoal()
      if self.action_result is None:
        self.action_result = arm_navigation_msgs.msg.SyncPlanningSceneActionResult()
      if self.action_feedback is None:
        self.action_feedback = arm_navigation_msgs.msg.SyncPlanningSceneActionFeedback()
    else:
      self.action_goal = arm_navigation_msgs.msg.SyncPlanningSceneActionGoal()
      self.action_result = arm_navigation_msgs.msg.SyncPlanningSceneActionResult()
      self.action_feedback = arm_navigation_msgs.msg.SyncPlanningSceneActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.planning_scene.robot_state.joint_state.header.seq, _x.action_goal.goal.planning_scene.robot_state.joint_state.header.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.joint_state.header.stamp.nsecs))
      _x = self.action_goal.goal.planning_scene.robot_state.joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.robot_state.joint_state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.planning_scene.robot_state.joint_state.position))
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.planning_scene.robot_state.joint_state.velocity))
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.planning_scene.robot_state.joint_state.effort))
      _x = self
      buff.write(_struct_2I.pack(_x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.joint_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.child_frame_ids)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.child_frame_ids:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.poses:
        _v1 = val1.position
        _x = _v1
      ...
      length = len(self.action_goal.goal.planning_scene.fixed_frame_transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.fixed_frame_transforms:
        _v3 = val1.header
        ...
        _x = _v7
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.action_goal.goal.planning_scene.allowed_collision_matrix.link_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.allowed_collision_matrix.link_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.planning_scene.allowed_collision_matrix.entries)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.allowed_collision_matrix.entries:
        length = len(val1.enabled)
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.enabled))
      length = len(self.action_goal.goal.planning_scene.allowed_contacts)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.allowed_contacts:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.action_goal.goal.planning_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.link_padding:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.action_goal.goal.planning_scene.collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.collision_objects:
        _v15 = val1.header
        ...
        for val2 in val1.poses:
          ...
          _x = _v19
          buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.action_goal.goal.planning_scene.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        for val2 in val1.touch_links:
          ...
          buff.write(struct.pack('<I%ss'%length, length, val2))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.planning_scene.collision_map.header.seq, _x.action_goal.goal.planning_scene.collision_map.header.stamp.secs, _x.action_goal.goal.planning_scene.collision_map.header.stamp.nsecs))
      _x = self.action_goal.goal.planning_scene.collision_map.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.planning_scene.collision_map.boxes)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.planning_scene.collision_map.boxes:
        _v26 = val1.center
        _x = _v26
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.ok, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B.pack(_x.action_feedback.feedback.client_processing, _x.action_feedback.feedback.ready))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.planning_scene.robot_state.joint_state.header.seq, _x.action_goal.goal.planning_scene.robot_state.joint_state.header.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.joint_state.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.planning_scene.robot_state.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.planning_scene.robot_state.joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.robot_state.joint_state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.planning_scene.robot_state.joint_state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 8
      (_x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.joint_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.joint_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.child_frame_ids = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.child_frame_ids.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.poses = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.poses.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.fixed_frame_transforms = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
        self.action_goal.goal.planning_scene.fixed_frame_transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.allowed_collision_matrix.link_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.planning_scene.allowed_collision_matrix.link_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.allowed_collision_matrix.entries = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.allowed_collision_matrix.entries.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.allowed_contacts = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.allowed_contacts.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.link_padding = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.link_padding.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.collision_objects = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.collision_objects.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.attached_collision_objects = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.attached_collision_objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.action_goal.goal.planning_scene.collision_map.header.seq, _x.action_goal.goal.planning_scene.collision_map.header.stamp.secs, _x.action_goal.goal.planning_scene.collision_map.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.planning_scene.collision_map.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.planning_scene.collision_map.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.planning_scene.collision_map.boxes = []
      for i in range(0, length):
        ...
        self.action_goal.goal.planning_scene.collision_map.boxes.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.ok, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_result.result.ok = bool(self.action_result.result.ok)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.client_processing, _x.action_feedback.feedback.ready,) = _struct_2B.unpack(str[start:end])
      self.action_feedback.feedback.client_processing = bool(self.action_feedback.feedback.client_processing)
      self.action_feedback.feedback.ready = bool(self.action_feedback.feedback.ready)
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.planning_scene.robot_state.joint_state.position.tostring())
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.planning_scene.robot_state.joint_state.velocity.tostring())
      length = len(self.action_goal.goal.planning_scene.robot_state.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.planning_scene.robot_state.joint_state.effort.tostring())
      _x = self
      buff.write(_struct_2I.pack(_x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.nsecs))
      length = len(self.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.joint_names)
      buff.write(_struct_I.pack(length))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_goal.goal.planning_scene.robot_state.joint_state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 8
      (_x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.secs, _x.action_goal.goal.planning_scene.robot_state.multi_dof_joint_state.stamp.nsecs,) = _struct_2I.unpack(str[start:end])
