...
int main(int argc, char **argv){
  ros::init (argc, argv, "bioloid_get_fk");
  ros::NodeHandle rh;

  ros::service::waitForService("l_arm/get_ik_solver_info");
  ros::service::waitForService("l_arm/get_ik");

  ros::ServiceClient query_client = rh.serviceClient <kinematics_msgs::GetKinematicSolverInfo> ("l_arm/get_fk_solver_info");
  ros::ServiceClient fk_client = rh.serviceClient <kinematics_msgs::GetPositionFK>("l_arm/get_fk");
  ...
  fk_request.fk_link_names[0] = "L_shoulder";
  fk_request.fk_link_names[1] = "L_upper_arm";
