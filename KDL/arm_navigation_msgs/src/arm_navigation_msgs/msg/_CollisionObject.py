"""autogenerated by genpy from arm_navigation_msgs/CollisionObject.msg. Do not edit."""
import sys
...
class CollisionObject(genpy.Message):
  _md5sum = "7b972910c23ece1b873b3de0cf92ba97"
  _type = "arm_navigation_msgs/CollisionObject"
...
"""
  __slots__ = ['header','id','padding','operation','shapes','poses']
  _slot_types = ['std_msgs/Header','string','float32','arm_navigation_msgs/CollisionObjectOperation','arm_navigation_msgs/Shape[]','geometry_msgs/Pose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,padding,operation,shapes,poses
    ...
    if args or kwds:
      ...
      if self.operation is None:
        self.operation = arm_navigation_msgs.msg.CollisionObjectOperation()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_fb.pack(_x.padding, _x.operation.operation))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.padding, _x.operation.operation,) = _struct_fb.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.shapes = []
