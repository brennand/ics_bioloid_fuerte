"""autogenerated by genpy from arm_navigation_msgs/ContactInformation.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','geometry_msgs/Vector3','float64','string','string','uint32','string','string','uint32']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.attached_body_1 = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.attached_body_2 = str[start:end].decode('utf-8')
      else:
