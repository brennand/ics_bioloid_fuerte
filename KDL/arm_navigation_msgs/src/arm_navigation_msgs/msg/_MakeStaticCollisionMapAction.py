"""autogenerated by genpy from arm_navigation_msgs/MakeStaticCollisionMapAction.msg. Do not edit."""
import sys
...
class MakeStaticCollisionMapAction(genpy.Message):
  _md5sum = "aa13998383a2996b29b6fe4862547a17"
  _type = "arm_navigation_msgs/MakeStaticCollisionMapAction"
...
"""
  ...
  _slot_types = ['arm_navigation_msgs/MakeStaticCollisionMapActionGoal','arm_navigation_msgs/MakeStaticCollisionMapActionResult','arm_navigation_msgs/MakeStaticCollisionMapActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakeStaticCollisionMapAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = arm_navigation_msgs.msg.MakeStaticCollisionMapActionGoal()
      if self.action_result is None:
        self.action_result = arm_navigation_msgs.msg.MakeStaticCollisionMapActionResult()
      if self.action_feedback is None:
        self.action_feedback = arm_navigation_msgs.msg.MakeStaticCollisionMapActionFeedback()
    else:
      self.action_goal = arm_navigation_msgs.msg.MakeStaticCollisionMapActionGoal()
      self.action_result = arm_navigation_msgs.msg.MakeStaticCollisionMapActionResult()
      self.action_feedback = arm_navigation_msgs.msg.MakeStaticCollisionMapActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.cloud_source
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.number_of_clouds, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.cloud_source = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.cloud_source = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.number_of_clouds, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
